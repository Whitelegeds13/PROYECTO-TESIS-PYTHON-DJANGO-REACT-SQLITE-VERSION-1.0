...
SECRET_KEY = 'django-insecure-jrr4hy_5z@&o&)im8%%yptr+#$-@=5ab5fe_89#m81=n5yxg&g'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('MONGODB_URI', 'mongodb://localhost:27017/?replicaSet=rs0'),
        'NAME': os.getenv('MONGODB_NAME', 'palacio_gamer'),
        'OPTIONS': {
